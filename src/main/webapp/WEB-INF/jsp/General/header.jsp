        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="/ProjectTeamF-1.0/index.html">Team F</a>
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            <li class="active"><a href="/ProjectTeamF-1.0/index.html">Home</a></li>
                        ...
                        <li class="pull-right"><a href="/ProjectTeamF-1.0/user/user.html">Registreer</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <form id="header_login_form" method="POST" action="user/login">
