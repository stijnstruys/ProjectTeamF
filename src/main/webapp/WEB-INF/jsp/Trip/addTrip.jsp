...
<form:form method="post" action="add.html" commandName="trip" id="add_trip_form" class="form-horizontal">
    ...
    <div id="add_trip_2" class="add_trip_div">
        ...
        <div class="control-group">
            <form:label class="control-label" path="tripDescription"><spring:message
    ...
    <div id="add_trip_3" class="add_trip_div">
        <div class="control-group" id="cg_startdate">
            ...
            <div class="controls">
                <form:input id="TripStartD" class="datepicker" readonly="true" style="cursor: text;"
        ...
        <div class="control-group" id="cg_enddate">
            ...
            <div class="controls">
                <form:input id="TripEndD" class="datepicker" readonly="true" style="cursor: text;"
                            path="endDate"></form:input>
            </div>
        </div>
    </div>
    <div id="add_trip_4" class="add_trip_div">
        ...
        <div class="control-group" id="cg_repetition">
            ...
            <div class="controls">
                <input type="text" id="temdate" class="datepicker" readonly="true" style="cursor: text;"
                       name="dateUntill"/>
            </div>
        </div>
    </div>
    <div id="add_trip_5" class="add_trip_div">
        <div class="control-group">
            <form:label class="control-label" path="startLocation"><spring:message
        ...
        <div class="control-group">
            <form:label class="control-label" path="notification"><spring:message
                    code="label.notification"/></form:label>
            <div class="controls">
